  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-lx-cascades"></i> 系统通知管理
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="container">
      <div class="addButton">
        <el-button type="primary" @click="addCase">发布系统通知</el-button>
      </div>
      <el-table
        :data="tablePageData"
        border
      ...
      >
        ...
        <el-table-column prop="content" width="400" label="通知内容"></el-table-column>
    ...
    <!-- 编辑弹出框 -->
    <el-dialog title="消息详情" :visible.sync="editVisible" width="50%">
    ...
    <!-- 添加系统消息 -->
    <el-dialog title="消息详情" :visible.sync="addVisible" width="50%">
...
export default {
  ...
  methods: {
    saveCaseEdit() {
      ...
      this.$axios
        .post('/api/message/add', this.addForm)
        .then(res => {
    ...
    saveEdit() {
      this.$axios
        .post('/api/message/update', this.form)
        .then(res => {
          const resData = res.data
          if (resData.errno === 0) {
